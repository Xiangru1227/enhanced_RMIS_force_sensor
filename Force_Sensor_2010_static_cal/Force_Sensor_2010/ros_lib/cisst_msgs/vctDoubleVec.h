#ifndef _ROS_cisst_msgs_vctDoubleVec_h
#define _ROS_cisst_msgs_vctDoubleVec_h
...
namespace cisst_msgs
{
  ...
  class vctDoubleVec : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "cisst_msgs/vctDoubleVec"; };
